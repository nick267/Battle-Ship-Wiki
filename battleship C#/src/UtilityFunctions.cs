...
static class UtilityFunctions
{
    ...
    public static void DrawField(ISeaGrid grid, Player thePlayer, bool showShips, int gridSize)
    {
    ...
    private static void DrawCustomField(ISeaGrid grid, Player thePlayer, bool small, bool showShips, int left, int top, int width, int height, int cellWidth, int cellHeight, int cellGap, int gridSize)
    {
        // SwinGame.FillRectangle(Color.Blue, left, top, width, height)

        int rowTop;
        int colLeft;
		//overload function that takes two extra things(proamters) that will detemine grid size
        // Draw the grid (10X10)
